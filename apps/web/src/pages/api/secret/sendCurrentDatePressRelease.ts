import { sendWhatsAppMessage } from "@laitjy/callmebot";
import { prisma } from "@laitjy/db";
import type { MailDataRequired } from "@laitjy/sendgrid";
import { sendEmails } from "@laitjy/sendgrid";
